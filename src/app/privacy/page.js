                ...
                <div className="privacy-content">
                    <div className="privacy-section">
                        ...
                        <div className="privacy-dates">
                            <span>Last Updated On: 17-Apr-2024</span>
                            <span>Effective Date: 17-Apr-2024</span>
                        </div>
                    </div>
                    ...
                    <div className="privacy-section">
                        <h2>Your Rights:</h2>
                        <p>Depending on the law that applies, you may have a right to access and rectify or erase your personal data or receive a copy of your personal data, restrict or object to the active processing of your data, ask us to share (port) your personal information to another entity, withdraw any consent you provided to us to process your data, a right to lodge a complaint with a statutory authority and such other rights as may be relevant under applicable laws. To exercise these rights, you can write to us at bedwards@bepbi.com. We will respond to your request in accordance with applicable law. Do note that if you do not allow us to collect or process the required personal information or withdraw the consent to process the same for the required purposes, you may not be able to access or use the services for which your information was sought.</p>
                    </div>
                    ...
                    <div className="privacy-section">
                        ...
                        <p>If you have any queries or concerns about the processing of your information that is available with us, you may email our Grievance Officer at email: bedwards@bepbi.com. We will address your concerns in accordance with applicable law.</p>
                    </div>
                </div>
            </div>
            <Footer />
